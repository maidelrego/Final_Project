        ...
        return (
          <div>
            <Row>
              <Col>
                <div>
                  <img className="logo mb-5" alt={logo} src={logo}></img>
                </div>
              </Col>
            </Row>
            <Row>
            ...
            >
              ...
              <p className="text-muted">
                We need your address if you are chosing Delivery
              </p>
              ...
              <Col xs={4}>
                ...
                <div className="inputGroup">
                  <input
                    ...
                    type="radio"
                    name="finishColor"
                    checked={state.finishColor === "White Paint"}
                    value="White Paint"
                    onChange={updateState}
                  />
              ...
              <Col xs={4}>
                ...
                <div className="inputGroup">
                  <input
                    ...
                    type="radio"
                    name="finishColor"
                    checked={state.finishColor === "Grey Paint"}
                    value="Grey Paint"
                    onChange={updateState}
                  />
              ...
              <Col xs={4}>
                ...
                <div className="inputGroup">
                  <input
                    ...
                    type="radio"
                    name="finishColor"
                    checked={state.finishColor === "Easter Blue Paint"}
              ...
              <Col xs={4}>
                ...
                <div className="inputGroup">
                  <input
                    ...
                    type="radio"
                    name="finishColor"
                    checked={state.finishColor === "White Stain"}
                    value="White Stain"
                    onChange={updateState}
                  />
              ...
              <Col xs={4}>
                ...
                <div className="inputGroup">
                  <input
                    ...
                    type="radio"
                    name="finishColor"
                    checked={state.finishColor === "Grey Stain"}
                    value="Grey Stain"
                    onChange={updateState}
                  />
              ...
              <Col xs={4}>
                ...
                <div className="inputGroup">
                  <input
                    ...
                    type="radio"
                    name="finishColor"
                    checked={state.finishColor === "Medium Brown Stain"}
              ...
              <Col xs={4}>
                ...
                <div className="inputGroup">
                  <input
                    ...
                    type="radio"
                    name="doorDesign"
                    checked={state.doorDesign === "Arrow Door"}
                    value="Arrow Door"
                    onChange={updateState}
                  />
              ...
              <Col xs={4}>
                ...
                <div className="inputGroup">
                  <input
                    ...
                    type="radio"
                    name="doorDesign"
                    checked={state.doorDesign === "Chevron Door"}
                    value="Chevron Door"
                    onChange={updateState}
                  />
              ...
              <Col xs={4}>
                ...
                <div className="inputGroup">
                  <input
                    ...
                    type="radio"
                    name="doorDesign"
                    checked={state.doorDesign === "Multiple X Door"}
              ...
              <Col xs={6}>
                ...
                <div className="inputGroup">
                  <input
                    ...
                    type="radio"
                    name="doorDesign"
                    checked={state.doorDesign === "Curved Door"}
                    value="Curved Door"
                    onChange={updateState}
                  />
              ...
              <Col xs={6}>
                ...
                <div className="inputGroup">
                  <input
                    ...
                    type="radio"
                    name="doorDesign"
                    checked={state.doorDesign === "Paneled Door"}
                    value="Paneled Door"
                    onChange={updateState}
                  />
              ...
              <Col xs={4}>
                ...
                <div className="inputGroup">
                  <input
                    ...
                    type="radio"
                    name="doorKit"
                    checked={state.doorKit === "J Shape Hanger"}
              ...
              <Col xs={4}>
                ...
                <div className="inputGroup">
                  <input
                    ...
                    type="radio"
                    name="doorKit"
                    checked={state.doorKit === "Rhombic Shape Hanger"}
              ...
              <Col xs={4}>
                ...
                <div className="inputGroup">
                  <input
                    ...
                    type="radio"
                    name="doorKit"
                    checked={state.doorKit === "Big Wheel Hanger"}
              ...
              <Col xs={4}>
                ...
                <div className="inputGroup">
                  <input
                    ...
                    type="radio"
                    name="handle"
                    checked={state.handle === "Round with Latch"}
      ...
      case 5:
        return (
          <div>
              ...
              <Col>
                <div className="inputGroup">
                  <input
                    id="radio1"
                    type="radio"
                    name="installOrDelivery"
                    checked={state.installOrDelivery === "Installation"}
                    value="Installation"
                    onChange={updateState}
                  />
              ...
              <Col>
                <div className="inputGroup">
                  <input
                    ...
                    type="radio"
                    name="installOrDelivery"
                    checked={state.installOrDelivery === "Delivery"}
                    value="Delivery"
                    onChange={updateState}
                  />
            ...
            <button
              type="submit"
              disabled={!state.installOrDelivery}
              onClick={handleNext}
              className="btn btn-primary"
            >
              Next
          ...
          <Form className="text-center mb-5" onSubmit={handleNext}>
            ...
            <Row>
              <Col xs={6}>
                ...
                <p className="detailsText">{state.email}</p>
                <h3 className="caption">Phone Number:</h3>
                <p className="detailsText">{state.phoneNumber}</p>
            ...
            <Row className="mt-4">
              <Col xs={3}>
                ...
                <p className="detailsText">{state.finishColor}</p>
              </Col>

              <Col xs={3}>
                <h3 className="caption">Design:</h3>
                <p className="detailsText">{state.doorDesign}</p>
              </Col>

              <Col xs={3}>
                <h3 className="caption">Kit:</h3>
                <p className="detailsText">{state.doorKit}</p>
              </Col>

              <Col xs={3}>
                <h3 className="caption">Handle:</h3>
                <p className="detailsText">{state.handle}</p>
              </Col>
            </Row>
