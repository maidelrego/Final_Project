      ...
      <Row id='contact-form'>
        <Col>
          ...
          <Form noValidate validated={validated} onSubmit={handleSubmit}>
            <Form.Row>
              ...
              <Form.Group as={Col} xs="12">
                ...
                <Form.Control required type="email" name="email" onChange={updateState} />
                <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
          ...
          <ul className="contact-list mt-5 text-center">
            ...
            <li className="list-item"><i className="fa fa-envelope fa-2x"><span className="contact-text"><a href="mailto:#" title="Send me an email">campbellwooddesigns@gmail.com</a></span></i></li>
          </ul>
        </Col>
      </Row>
    </Container>
